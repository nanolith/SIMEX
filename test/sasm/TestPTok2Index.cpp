...
TEST(ptok2index, basicTest)
{
    ...
    EXPECT_EQ(5,  ptok2index(PTok::IfNDef));
    EXPECT_EQ(6,  ptok2index(PTok::If));
    EXPECT_EQ(7,  ptok2index(PTok::ElIf));
    EXPECT_EQ(8,  ptok2index(PTok::Else));
    EXPECT_EQ(9,  ptok2index(PTok::Pragma));
    EXPECT_EQ(10, ptok2index(PTok::Warning));
    EXPECT_EQ(11, ptok2index(PTok::Error));
    EXPECT_EQ(12, ptok2index(PTok::And));
    EXPECT_EQ(13, ptok2index(PTok::Or));
    EXPECT_EQ(14, ptok2index(PTok::Not));
    EXPECT_EQ(15, ptok2index(PTok::OParen));
    EXPECT_EQ(16, ptok2index(PTok::CParen));
    EXPECT_EQ(17, ptok2index(PTok::Comma));
    EXPECT_EQ(18, ptok2index(PTok::Identifier));
    EXPECT_EQ(19, ptok2index(PTok::Integer));
    EXPECT_EQ(20, ptok2index(PTok::Number));
    EXPECT_EQ(21, ptok2index(PTok::Concat));
